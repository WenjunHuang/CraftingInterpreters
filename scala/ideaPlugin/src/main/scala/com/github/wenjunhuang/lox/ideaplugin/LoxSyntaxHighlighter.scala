...
object LoxSyntaxHighlighter:
  ...
  val IDENTIFIER: TextAttributesKey    =
    createTextAttributesKey("LOX_IDENTIFIER", DefaultLanguageHighlighterColors.IDENTIFIER)
  val KEY: TextAttributesKey           = createTextAttributesKey("LOX_KEY", DefaultLanguageHighlighterColors.KEYWORD)
